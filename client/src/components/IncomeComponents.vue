<template>
    <div class="container my-4">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <span class="badge badge-primary mt-2 mb-4 w-100" style="font-size: 20px;">Income</span>
        ...
        <div class="row">
            <div class="col-md-12">
                <div>
                    <b-modal title="Edit Income" v-model="modalShow" :centered="true" @ok="updateExpense()" @hide="getExpenses()">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
...
export default {
    ...
    computed: {
        ...
        orderedExpenses: function (){
            return _.orderBy(this.filterByMonth, 'date', 'desc')
        }, 
    ...
    methods: {
        async loadMore(){
            const response = await IncomeService.getExpenses()
            this.busy = true
        ...
        async getExpenses(){
            this.expenses = await IncomeService.getExpenses()
        }, 
        async addExpense(){
            if(this.inputexp.amount && this.inputexp.date){
                this.isLoading = true
                await IncomeService.insertExpense(
        ...
        async updateExpense(){
            ...
            this.isLoading = true
            await IncomeService.updateExpense(
                this.editexp._id, 
                this.editexp.amount, 
        ...
        async removeExpense(id){
            this.isLoading = true
            await IncomeService.deleteExpense(id)
            this.expenses = await IncomeService.getExpenses()
            this.isLoading = false
        }
    }
